...
\frametitle{Nasvícení fotonásobičů}
 \begin{figure}[H]
 \centering
 \includegraphics[scale=0.2, angle = 0, origin = c]{../BachelorThesis/pictures/CalibPulses}
...
\frametitle{Monitorovací systém}
 \begin{figure}[H]
 \centering
 \includegraphics[scale=0.13, angle = 0, origin = c]{../BachelorThesis/pictures/monitoringScheme}
